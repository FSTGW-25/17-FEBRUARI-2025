...
<body>
  <div class="title-box">28 Hari Lagi Kak Thania Theresia Podung Ulang Tahun! 🎉🎂🥳</div>
  ...
  <div id="photo-gallery" class="photo-gallery" style="display: none;">
    <div class="gallery-container">
      <img src="foto 1.jpeg" class="gallery-photo">
    </div>
  </div>
  ...
  <script>
    ...
    const fullMessage = `"Kebahagiaan sejati bukan tentang hal-hal besar, tetapi tentang bagaimana kita menikmati setiap momen dan proses yang ada 🤍🌿. Ketika kita belajar bersyukur atas hal-hal sederhana 🌼✨, hidup pun menjadi lebih bermakna 🌈. Hargai setiap detik ⏳, karena justru hal-hal kecil itulah yang membuatnya begitu istimewa 🌻."`;
